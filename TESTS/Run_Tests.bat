...
echo Testing ... [ Insightful ]
echo ****************************************************************************************
coverage run --source=..\..\Insightful -m pytest --template=html1/index.html --report=..\REPORTS\TestCaseResults.html > ..\REPORTS\run_%fullstamp%.txt
